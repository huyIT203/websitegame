    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="./" class="brand-link">
            <img src="../src/images/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                style="opacity: .8">
            <span class="brand-text font-weight-light">Xin chào , Huy</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview <?php echo ($Page === 'category') ? 'menu-open' : ''; ?>">
                        <a href="#" class="nav-link <?php echo ($Page === 'category') ? 'active' : ''; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="./categories.php" class="nav-link <?php echo ($Menu === 'categories') ? 'active' : ''; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>View Categories</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="./add_category.php" class="nav-link <?php echo ($Menu === 'addcategory') ? 'active' : ''; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Add Category</p>
                                </a>
                            </li>
